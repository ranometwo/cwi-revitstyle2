    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">CreateWalls</h3>
            <p className="text-gray-400 mb-4">
              The enterprise-grade Revit plugin that transforms wall creation workflows.
            </p>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-sm text-gray-400 flex flex-col md:flex-row justify-between items-center">
          <p>© 2025 CreateWalls. All rights reserved.</p>
