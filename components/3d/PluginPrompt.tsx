...
const PluginPrompt = ({ wallCount, timeSaved, timeSpent }: PluginPromptProps) => {
  ...
  return (
    <AnimatePresence>
      {showPrompt && (
        ...
        >
          <motion.div 
            className="bg-white border border-blue-500 rounded-lg shadow-lg p-6 max-w-md mx-4"
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <h2 className="text-xl font-bold text-blue-700">Experience in Revit</h2>
              <button 
                onClick={handleClose}
            ...
            <div className="mb-4">
              <p className="text-gray-800 mb-3">
                You've created <span className="font-bold text-green-700">{wallCount} walls</span> and saved <span className="font-bold text-blue-700">{timeSaved.toFixed(2)} minutes</span>!
              </p>
              ...
              <div className="bg-blue-50 p-3 rounded-md border border-blue-200 mb-3">
                <h3 className="font-bold text-blue-700 mb-1">Plugin Benefits:</h3>
            ...
            <div className="flex justify-center">
              <motion.button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-md shadow-lg flex items-center"
